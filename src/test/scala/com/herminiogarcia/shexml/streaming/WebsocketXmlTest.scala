...
class WebsocketXmlTest extends AnyFunSuite with RDFStatementCreator with ResultRetriever {

  private val prefix = "http://example.com/"
  private val output = retrieveResult("src/test/resources/websocketFilmsXml.shexml")
