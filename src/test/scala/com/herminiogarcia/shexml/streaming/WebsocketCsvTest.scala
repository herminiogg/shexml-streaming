...
class WebsocketCsvTest extends AnyFunSuite with RDFStatementCreator with ResultRetriever {

  private val prefix = "http://example.com/"
  private val output = retrieveResult("src/test/resources/websocketFilmsCsv.shexml")
